@extends('layouts.app', ['activePage' => 'roleEdit', 'titlePage' => __('Role Edit')])
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="
							...
							py-1
						">
                        <h4 class="card-title m-0 pt-2">Role Edit</h4>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="role-{{$group}}">
                                        ...
                                        <input type="checkbox" name="permissions[]" id="{{$item->name}}" value="{{ $item->id}}" {{$role->hasPermissionTo($item->name) ? 'checked' : ''}}>
